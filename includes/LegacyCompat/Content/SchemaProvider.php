...
class SchemaProvider {
     ...
     * @return string
     */
    public function getLocalStorePath(): string {
     ...
     * @return string
     */
    public function getBaseExternalPath(): string {
    ...
    public function getAllowedSchemaRepos(): array {
        return [
